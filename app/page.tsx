...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-blue-50 text-gray-800 font-sans selection:bg-indigo-500/30">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 pt-10 pb-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="mt-6 max-w-2xl text-xl text-gray-500 sm:text-2xl leading-relaxed">
                {t('hero.subtitle')}
              </p>
            </div>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('sam.title')}</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="prose prose-blue max-w-none">
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('sam.whatIsIt.title')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('sam.whatIsIt.content')}</p>
              </div>

              {/* When is it used? */}
              <div className="prose prose-blue max-w-none">
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('sam.whenIsItUsed.title')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('sam.whenIsItUsed.content')}</p>
              </div>

              {/* Data Look Like */}
              <div className="prose prose-blue max-w-none">
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('sam.dataLookLike.title')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('sam.dataLookLike.content')}</p>
              </div>
            </div>

            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-6">{t('sam.howDoesItWork.title')}</h3>
              
              <div className="mb-8 p-4 bg-blue-50 rounded-xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">{t('sam.howDoesItWork.example.title')}</h4>
                <p className="text-sm text-blue-800">{t('sam.howDoesItWork.example.description')}</p>
              </div>

              <ol className="space-y-6 relative border-l-2 border-blue-200 ml-3">
                {(t('sam.howDoesItWork.steps', { returnObjects: true }) as string[]).map((step, index) => (
